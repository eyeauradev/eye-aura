        ...
        <Card className="border-primary/10 shadow-[0_8px_40px_rgba(15,79,75,0.09)]">
          <CardContent className="px-6 py-8 sm:px-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-[18px] w-[18px] text-muted-foreground/70 pointer-events-none" />
                  <Input
                    id="displayName"
                    type="text"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 h-[18px] w-[18px] text-muted-foreground/70 pointer-events-none" />
                  <Input
                    id="password"
                    ...
                    className="pl-10 pr-11 focus-visible:ring-2 focus-visible:ring-primary/25 focus-visible:border-primary/50 focus-visible:shadow-[0_0_0_4px_rgba(15,79,75,0.08)] transition-[border-color,box-shadow] duration-200"
                    required
                    minLength={8}
                  />
                  <button
                    ...
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-muted-foreground/70 hover:text-primary transition-colors duration-150 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/25"
                  >
                    {showPassword ? <EyeOff className="h-[18px] w-[18px]" /> : <Eye className="h-[18px] w-[18px]" />}
                  </button>
                </div>
                <p className="text-xs text-muted-foreground/80 pl-0.5">
              ...
              {error && (
                ...
                >
                  ...
                  {showLoginLink && (
                    <div className="mt-2">
                      <Link href="/auth/login" className="font-semibold text-primary hover:underline underline-offset-2">
                        Sign in instead →
                      </Link>
                    </div>
                  )}
              ...
              <div className="relative flex items-center gap-3 py-1">
                <div className="flex-1 border-t border-primary/12" />
                <span className="text-xs font-medium text-muted-foreground/70 tracking-wide select-none">
                  or continue with
                </span>
                <div className="flex-1 border-t border-primary/12" />
              </div>
              ...
              <button
                ...
                className="
                  ...
                  bg-[#F8F8F6] border border-primary/16
                  text-sm font-semibold text-foreground
                  shadow-[0_1px_3px_rgba(15,79,75,0.07),0_1px_2px_rgba(0,0,0,0.04)]
                  hover:bg-[#F2F2EF] hover:border-primary/22 hover:shadow-[0_2px_6px_rgba(15,79,75,0.10)]
                  active:scale-[0.98] active:bg-[#EBEBEA]
            ...
            <p className="mt-6 text-center text-sm text-muted-foreground">
              ...
              <Link href="/auth/login" className="font-semibold text-primary hover:underline underline-offset-2 transition-colors duration-150">
                Sign in
              </Link>
            </p>
          </CardContent>
