...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logError(appError.code, err, "LoginForm");
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <p className="mt-2.5 text-base text-muted-foreground">
            Continue your eye wellness journey
          </p>
        </div>
        ...
        <Card className="border-primary/10 shadow-[0_8px_40px_rgba(15,79,75,0.09)]">
          <CardContent className="px-6 py-8 sm:px-8">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs font-medium text-primary/70 hover:text-primary transition-colors duration-150"
                  >
                    Forgot password?
                  </Link>
                </div>
            ...
            <p className="mt-6 text-center text-sm text-muted-foreground">
              ...
              <Link href="/auth/signup" className="font-semibold text-primary hover:underline underline-offset-2 transition-colors duration-150">
                Sign up
              </Link>
            </p>
          </CardContent>
